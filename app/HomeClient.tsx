...
import { ArrowRight, Star, TrendingUp, Sparkles, Wand2, Palette, ShoppingBag } from 'lucide-react'
...
const RecentlyViewedProducts = dynamic(
    ...
    {
        loading: () => <div className="h-64 animate-pulse bg-slate-900 rounded-xl" />,
        ssr: true
    }
)
...
const NewsletterSignup = dynamic(
    ...
    {
        loading: () => <div className="h-32 animate-pulse bg-slate-900 rounded-xl" />,
...
const ProductComparison = dynamic(
    ...
    {
        loading: () => <div className="h-96 animate-pulse bg-slate-900 rounded-xl" />,
        ssr: false
    }
)
...
export default function HomeClient({ featuredProducts }: HomeClientProps) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden" ref={targetRef}>
            <Navbar />
            ...
            <main>
                ...
                <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
                            ...
                            <div className="text-center lg:text-left space-y-8">
                                ...
                                <motion.div variants={fadeInUp} className="space-y-4">
                                    ...
                                    <p className="text-xl md:text-2xl text-slate-300 max-w-xl lg:max-w-none leading-relaxed font-medium">
                                        {t('home.hero.description') || "Descubre prendas exclusivas diseñadas por algoritmos inteligentes que entienden tu estilo único."}
                                    </p>
                                </motion.div>
                                ...
                                {/* Stats Strip */}
                                <motion.div variants={fadeInUp} className="pt-8 grid grid-cols-3 gap-6 max-w-md mx-auto lg:mx-0">
                                    {[
                                        { label: 'Usuarios', val: '2K+', icon: '👥' },
                                        { label: 'Diseños', val: '500+', icon: '✨' },
                    ...
                    >
                        ...
                        >
                            <span className="text-xs font-semibold uppercase tracking-wider">Descubre Más</span>
                ...
                <section className="py-24 bg-slate-950 relative overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="text-center mb-20">
                            ...
                            >
                                Nuestra suite de herramientas de IA personaliza cada aspecto de tu experiencia de moda.
                            </motion.p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
                            ...
                            >
                                ...
                                <div className="p-10 h-full flex flex-col justify-between relative z-10">
                                    <div>
                                        ...
                                        <h3 className="text-2xl font-bold mb-2 text-white">Análisis de Colorimetría</h3>
                                        <p className="text-slate-400">Sube tu foto y deja que nuestra IA detecte tu paleta de colores perfecta al instante.</p>
                                    </div>
                                    <Link href="/closet" className="text-indigo-400 font-bold flex items-center gap-2 group-hover:gap-4 transition-all">
                            ...
                            >
                                ...
                                <div className="p-10 h-full flex flex-col justify-end relative z-10">
                                    ...
                                    <p className="text-slate-300 mb-6">Organiza, visualiza y planifica tus outfits digitalmente.</p>
                                    <Link href="/closet">
                            ...
                            >
                                <div className="p-10 h-full flex flex-col justify-between relative z-10">
                                    <div>
                                        ...
                                        <h3 className="text-2xl font-bold mb-2">Generador de Outfits</h3>
                                        <p className="text-indigo-100 text-sm">¿No sabes qué ponerte? Deja que la magia suceda.</p>
                                    </div>
                                </div>
                            ...
                            >
                                <div className="p-10 h-full flex flex-col justify-center items-center text-center relative z-10">
                                    ...
                                    <h3 className="font-bold text-lg text-white">Únete a la comunidad</h3>
                                    <p className="text-sm text-slate-400 mt-2">Comparte tus creaciones únicas.</p>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                ...
                <section className="py-32 bg-slate-950 overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 flex items-end justify-between">
                        <div>
                            ...
                            >
                                Los Más <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Deseados</span>
                            </motion.h2>
                        </div>
                    ...
                    >
                        ...
                        <div className="min-w-[200px] flex items-center justify-center">
                            <Link href="/productos" className="w-full h-[400px] rounded-[2rem] border-2 border-dashed border-slate-800 flex flex-col items-center justify-center text-slate-500 hover:text-indigo-400 hover:border-indigo-500/50 hover:bg-slate-900 transition-all font-bold gap-4 group cursor-pointer">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                        ...
                        >
                            ...
                            <p className="text-indigo-100 text-lg mb-10 max-w-lg mx-auto leading-relaxed">
                                Sé el primero en experimentar nuevas features de IA y recibir drops exclusivos.
                            </p>
