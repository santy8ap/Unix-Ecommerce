...
export default function AIStyleAssistant({ onComplete }: StyleAssistantProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "¡Hola! Soy tu asistente de moda con IA. Voy a ayudarte a descubrir tu estilo único y los colores que más te favorecen. ¿Empezamos?",
      timestamp: new Date(),
    },
  ]);
  ...
  const quickReplies =
    conversationStep === 0 ? ["Sí, ¡empecemos!", "Cuéntame  más"] : [];
      ...
      <div className="relative w-full max-w-4xl">
        ...
        >
          ...
          <p className="text-slate-400">
            Conversación con IA • Powered by Gemini
          </p>
        </motion.div>
