...
import { Settings, Package, LogOut, Shirt, Sparkles } from "lucide-react";
            ...
            >
              ...
              <div className="py-2">
                ...
                <Link
                  ...
                  onClick={() => setShowUserMenu(false)}
                >
                  <Shirt className="w-4 h-4 mr-3 text-gray-400 group-hover:text-red-500 transition-colors" />
                  <span className="group-hover:text-red-600 font-medium">
                    Mi Armario
                  </span>
                </Link>
                ...
                <Link
                  ...
                  onClick={() => setShowUserMenu(false)}
                >
                  <Sparkles className="w-4 h-4 mr-3 text-gray-400 group-hover:text-red-500 transition-colors" />
                  <span className="group-hover:text-red-600 font-medium">
                    IA Stylist
                  </span>
                </Link>
